...
PROJECTS_DIR: Path = Path("projects1")
REPORTS_DIR_NAME: Text = "first_week"
...
if __name__ == "__main__":
    ...
    try:
        ...
        reports_dir: Path = selected_project 
        ...
        st.sidebar.markdown(
            ...
            <p style='text-align:center; font-size=small'>
                Made with ❤️ by Ch.G.S.V.Chennaiah<br>
          ''',unsafe_allow_html=True)
        st.sidebar.write("""
                         [![LinkedIn](https://img.shields.io/badge/LinkedIn-guna-orange)](https://www.linkedin.com/in/chakka-guna-sekhar-venkata-chennaiah-7a6985208)
                         """
